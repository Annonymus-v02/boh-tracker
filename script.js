...
let items = [
    ...
    new Item('Wormwood Dream', 'evolves nyctodromy and skolekosophy', {winter: 6, moon: 6, edge: 3, memory: 1, omen: 1, persistent: 1}),
    ...
    new Item('Inescapable Confinement', '', {knock: 5, scale: 5, winter: 5, numen: 1, memory: 1, persistent: 1}),
    new Item('Chimeric Larva', '', {knock: 2, moon: 2, moth: 4, beast: 1}),
    new Item('Mazarine Fife', '', {sky: 3, instrument: 1, tool: 1}),
    new Item('Thirza\'s Cordials', '', {moth: 2, nectar: 2, liquid: 1, beverage: 1}),
    new Item('Forbidden Epic', 'Evolves Horomachistry and Birdsong', {edge: 6, moon: 4, rose: 4, memory: 1, persistent: 1}),
    new Item('That Old Lost Music', '', {rose: 5, scale: 5, sky: 5, numen: 1, memory: 1, persistent: 1}),
    new Item('Serpent-Milk', '', {edge: 6, knock: 2, scale: 3, liquid: 1, beverage: 1}),
    new Item('Iotic Essence', '', {forge: 5, lantern: 3, liquid: 1, pigment: 1, fuel: 1}),
    new Item('Orpiment Exultant', '', {forge: 7, heart: 7, sky: 7, liquid: 1, ink: 1, encaustum: 1}),
    new Item('Azoth', '', {forge: 2, knock: 6, liquid: 1}),
    new Item('January Sanguinary', '', {Heart: 5, knock: 3, sky: 3, liquid: 1}),
    new Item('Stymphling', '', {scale: 3, moon: 3, beast: 1}),
    ...
    new Item('Wind-in-Waiting', 'evolves Bosk and Birdsong', {sky: 6, scale: 3, moth: 3, grail: 3, memory: 1, persistent: 1}),
    new Item('Weaving the World', '', {heart: 5, moon: 5, nectar: 5, numen: 1, memory: 1, persistent: 1}),
    new Item('Marakat', '', {nectar: 7, grail: 7, knock: 7, liquid: 1, ink: 1, encaustum: 1}),
    new Item('Chronsichord', '', {forge: 3, sky: 3, knock: 6, winter: 3, tool: 1, device: 1}),
    new Item('Porphyrine', '', {rose: 7, moon: 7, knock: 7, liquid: 1, ink: 1, encaustum: 1}),
];
...
let recipes = [
    ...
    new CraftingRecipe('Perilous Imago', 'Resurgences & Emergences', 'moth', 15, 'and a Chimeric Larva'),
    new CraftingRecipe('Perilous Imago', 'Transformations & Liberations', 'moth', 15, 'and a Chimeric Larva'),
    ...
    new CraftingRecipe('Yewgall Ink', 'Inks of Revelation', 'nectar', 5, ''),
    new CraftingRecipe('Chimeric Larva', 'Resurgences & Emergences', 'moth', 10, 'and an :egg: egg'),
    new CraftingRecipe('Chimeric Larva', 'Horns & Ivories', 'knock', 10, 'and an :egg: egg'),
    new CraftingRecipe('Refulgin', 'Purifications & Exaltations', 'lantern', 5),
    new CraftingRecipe('Xanthotic Essence', 'Purifications & Exaltations', 'lantern', 10, 'and a :liquid: liquid, probably'),
    new CraftingRecipe('Dearday Lens', 'Glaziery and Lightsmithing', 'lantern', 5),
    new CraftingRecipe('Ichor Vitreous', 'Glaziery and Lightsmithing', 'lantern', 10, 'and :glass: glass'),
    new CraftingRecipe('Refulgin', 'Sacra Solis Invicti', 'lantern', 5),
    new CraftingRecipe('Ichor Vitreous', 'Sacra Solis Invicti', 'lantern', 10, 'and :glass: glass'),
    new CraftingRecipe('Frith-Weft', 'Stitching & Binding', 'heart', 10, 'and :fabric: fabric'),
    new CraftingRecipe('Perhibiate', 'Stitching & Binding', 'heart', 5),
    new CraftingRecipe('Thirza\'s Cordials', 'Herbs & Infusions', 'nectar', 5),
    new CraftingRecipe('Thirza\'s Cordials', 'Stone Stories', 'nectar', 5),
    ...
    new CraftingRecipe('Confounding Parable', 'Applebright Euphonies', 'sky', 5),
    new CraftingRecipe('Ascendant Harmony', 'Applebright Euphonies', 'sky', 10, 'at an :instrument: instrument, probably'),
    new CraftingRecipe('Torgue\'s Cleansing', 'Purifications & Exaltations', 'sky', 5),
    new CraftingRecipe('Ascendant Harmony', 'Purifications & Exaltations', 'sky', 10, 'at an :instrument: instrument, probably'),
    new CraftingRecipe('Dearday Lens', 'Glaziery and Lightsmithing', 'sky', 5),
    new CraftingRecipe('Awakened Feather', 'Stitching & Binding', 'sky', 5),
    new CraftingRecipe('Confounding Parable', 'Sacra Solis Invicti', 'sky', 5),
    new CraftingRecipe('Mazarine Fife', 'Sacra Solis Invicti', 'sky', 10, 'and :wood: wood'),
    new CraftingRecipe('Wistful Air', 'Ouranoscopy', 'sky', 5),
    new CraftingRecipe('Mazarine Fife', 'Ouranoscopy', 'sky', 10, 'and :wood: wood'),
    new CraftingRecipe('Perinculate', 'Sickle & Eclipse', 'edge', 10, 'and a :leaf: leaf'),
    new CraftingRecipe('Perinculate', 'Edicts Martial', 'edge', 10, 'and a :leaf: leaf'),
    new CraftingRecipe('Perinculate', 'Disciplines of the Scar', 'edge', 10, 'and a :leaf: leaf'),
    new CraftingRecipe('Torgue\'s Cleansing', 'Sharps', 'edge', 5),
    new CraftingRecipe('Winning Move', 'Sharps', 'edge', 10, 'and a :memory: memory'),
    new CraftingRecipe('Winning Move', 'Meniscate Reflections', 'edge', 10, 'and a :memory: memory'),
    new CraftingRecipe('Serpent-Milk', 'Disciplines of the Scar', 'edge', 15, 'and Perinculate'),
    new CraftingRecipe('Serpent-Milk', 'Sickle & Eclipse', 'edge', 15, 'and Perinculate'),
    new CraftingRecipe('Orichalcum', 'Bells & Brazieries', 'forge', 10, 'and :metal: metal'),
    new CraftingRecipe('Azoth', 'Bells & Brazieries', 'forge', 15, 'and Orichalcum'),
    new CraftingRecipe('Iotic Essence', 'Anbary & Lapidary', 'forge', 10, 'and a :liquid: liquid'),
    new CraftingRecipe('Iotic Essence', 'Transformations & Liberations', 'forge', 10, 'and a :liquid: liquid'),
    new CraftingRecipe('Iotic Essence', 'Meniscate Reflections', 'forge', 10, 'and a :liquid: liquid'),
    new CraftingRecipe('Iotic Essence', 'Spices & Savours', 'forge', 10, 'and a :liquid: liquid'),
    new CraftingRecipe('Orichalcum', 'Disciplines of the Hammer', 'forge', 10, 'and :metal: metal'),
    new CraftingRecipe('Orichalcum', 'Door & Wall', 'forge', 10, 'and :metal: metal'),
    new CraftingRecipe('Azoth', 'Door & Wall', 'forge', 15, 'and Orichalcum'),
    new CraftingRecipe('Orpiment Exultant', 'Anbary & Lapidary', 'forge', 15, 'and Iotic Essence'),
    new CraftingRecipe('Orpiment Exultant', 'Transformations & Liberations', 'forge', 15, 'and Iotic Essence'),
    new CraftingRecipe('Azoth', 'Meniscate Reflections', 'forge', 15, 'and Orichalcum'),
    new CraftingRecipe('Azoth', 'Disciplines of the Hammer', 'forge', 15, 'and Orichalcum'),
    new CraftingRecipe('January Sanguinary', 'Maggephene Mysteries', 'heart', 15, 'and Gideon\'s Soaks'),
    new CraftingRecipe('Beguiling Melody', 'Tridesma Hiera', 'grail', 5),
    new CraftingRecipe('Stymphling', 'Tridesma Hiera', 'moon', 10, 'and an :egg: egg'),
    ...
    new CraftingRecipe('Wind-in-Waiting', 'Strings & Songs', 'sky', 15, 'and a Mazarine Fife'),
    new CraftingRecipe('Wind-in-Waiting', 'Furs & Feathers', 'sky', 15, 'and a Mazarine Fife'),
    new CraftingRecipe('Marakat', 'Tridesma Hiera', 'nectar', 15, 'and Leathy'),
    new CraftingRecipe('Marakat', 'Inks of Power', 'nectar', 15, 'and Leathy'),
    new CraftingRecipe('Marakat', 'Insects & Nectars', 'nectar', 15, 'and Leathy'),
    new CraftingRecipe('Leathy', 'Orchids & Narcotics', 'nectar', 10, 'and a :beverage: beverage'),
    new CraftingRecipe('Stargall Ink', 'Inks of Revelation', 'sky', 5),
    new CraftingRecipe('Enduring Reflection', 'Preliminal Meter', 'rose', 10, 'and a :memory: memory'),
    new CraftingRecipe('Ichor Auroral', 'Inks of Power', 'rose', 10, 'and a :light: light'),
    new CraftingRecipe('Horizon-Sight', 'Preliminal Meter', 'rose', 15, 'and Enduring Reflection'),
    new CraftingRecipe('Horizon-Sight', 'Path & Pilgrim', 'rose', 15, 'and Enduring Reflection'),
    new CraftingRecipe('Chronsichord', 'Lockworks & Clockworks', 'knock', 15, 'and Gervinite'),
    new CraftingRecipe('Chronsichord', 'The Great Signs and the Great Scars', 'knock', 15, 'and Gervinite'),
    new CraftingRecipe('Chronsichord', 'Glassblowing & Vesselcrafting', 'knock', 15, 'and Gervinite'),
    new CraftingRecipe('Chronsichord', 'Preliminal Meter', 'knock', 15, 'and Gervinite'),
    new CraftingRecipe('Bittersweet Certainty', 'Ouranoscopy', 'moon', 5),
    new CraftingRecipe('Bittersweet Certainty', 'Ouranoscopy', 'winter', 5),
    new CraftingRecipe('Year-Tally', 'Ouranoscopy', 'sky', 15, 'and Essential Periost'),
    new CraftingRecipe('Asimel', 'Ouranoscopy', 'moon', 10, 'and a :lens: lens'),
    new CraftingRecipe('Porphyrine', 'Inks of Power', 'rose', 15, 'and Ichor Auroral'),
    ...
    new Recipe('Fear', 'Read Medusa\'s Lament'),
    new Recipe('Inescapable Confinement', 'Read Towards a Fundamental Aesthetic'),
    ...
    new Recipe('Fear', 'Read A True History of Valentine Dewulf'),
    new Recipe('Weaving the World', 'Read Kopralith Omphalos'),
    new Recipe('Satisfaction', 'Read A Catalogue of Uncharted Pleasures'),
    new Recipe('Foresight', 'Read In the Malleary'),
    new Recipe('Satisfaction', 'Read Two Wombs, One Heart'),
